...
export default function ReadingLexicon() {
  ...
  const genreOptions = [
    { id: 'Story / Tale', label: 'Story / Tale' },
    { id: 'News / Article', label: 'News / Article' },
    { id: 'Essay / Blog', label: 'Essay / Blog' },
    { id: 'Dialogue / Chat', label: 'Dialogue / Chat' },
    { id: 'Notice / Flyer', label: 'Notice / Flyer' },
    { id: 'Email / Letter', label: 'Email / Letter' }
  ];
  ...
  const filteredData = entries.filter(entry => {
    ...
    const matchGenre = filterGenre === 'all' || entry.genre === filterGenre;
