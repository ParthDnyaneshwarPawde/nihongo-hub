...
import { 
  ...
  Volume2, Lightbulb, AlertTriangle, AlertCircle, Image as ImageIcon, Link as LinkIcon, Split
} from 'lucide-react';
...
export default function GrammarLexicon() {
  ...
  // SAFE ARRAY PARSERS FOR MODAL (Ensures backward compatibility with old data)
