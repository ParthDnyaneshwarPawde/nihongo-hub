...
import { 
  ...
  Users, Search, X, Check, Send, Filter, 
  LayoutGrid, LayoutList, ChevronLeft, ChevronRight, 
  Globe, Sparkles, Trash2, Loader2, Shield, ArrowRight, UserPlus, Clock, BookOpen
} from 'lucide-react';
...
export default function ExamCreatorTab() {
  ...
  const INITIAL_EXAM_STATE = {
    title: '',
    description: '',
    targetLevel: 'JLPT N4', // 🆕 Blueprint Detail
    durationMinutes: 90,    // 🆕 Blueprint Detail
  ...
  const labelPremiumClass = `block text-[10px] font-black uppercase text-slate-500 tracking-[0.2em] ml-2 mb-2.5`;
    ...
    <div className="flex flex-col h-full max-w-[1500px] w-full mx-auto relative select-none pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        <div>
          ...
          <p className="text-sm font-bold text-slate-500 mt-1">Design high-fidelity custom assessment templates. Execution rules are managed in the Series Architect.</p>
        </div>
        {!isExamFormOpen && (
          <button 
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 animate-in slide-in-from-right-8 duration-500">
              ...
              <div className="space-y-8">
                ...
                {/* 🆕 NEW: Replaced Access Key & Launch Mode with Level & Duration */}
            ...
            <div className="flex gap-4 sticky bottom-6 z-30 bg-[#090E1A]/95 backdrop-blur-md p-3 rounded-2xl border border-slate-800 shadow-2xl max-w-lg mx-auto mt-10">
              ...
              <button type="submit" disabled={isSaving} className="flex-1 py-3 bg-white text-black rounded-xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95">
