                  ...
                  <div key={matrixExam.testId} className={`p-8 rounded-[2.5rem] border-2 transition-all duration-300 flex flex-col justify-between group shadow-2xl relative overflow-hidden ${cardClasses}`}>
                    ...
                    <div className="flex justify-between items-start mb-6 relative z-10">
                      <div className="flex flex-col gap-2">
                        <span className="self-start px-2.5 py-1 rounded-md bg-slate-900 border border-slate-800 text-slate-400 text-[8px] font-black uppercase tracking-widest">{blueprint.targetLevel}</span>
                        <span className={`self-start px-3 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest border ${
