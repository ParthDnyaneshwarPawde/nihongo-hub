...
import { 
  ...
  Shield, ArrowRight, BookOpen, Layers
} from 'lucide-react';
          ...
          <motion.div key="grid" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
            ...
            <div className="flex items-center justify-between border border-slate-800/80 rounded-[1.5rem] p-2.5 mb-8 bg-[#0B1120]/60 backdrop-blur-md shadow-lg">
              <div className="flex items-center gap-2 overflow-x-auto custom-scrollbar">
                 ...
                 <button onClick={() => setActiveFilter('active')} className={`flex items-center gap-2 px-6 py-3.5 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all ${activeFilter === 'active' ? 'bg-slate-800 text-white shadow-md' : 'text-slate-500 hover:text-white hover:bg-slate-800/50'}`}>
                    <Activity size={14}/> Active Execution
                 </button>
                 <button onClick={() => setActiveFilter('upcoming')} className={`flex items-center gap-2 px-6 py-3.5 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all ${activeFilter === 'upcoming' ? 'bg-slate-800 text-white shadow-md' : 'text-slate-500 hover:text-white hover:bg-slate-800/50'}`}>
                    <Calendar size={14}/> Staged / Upcoming
                 </button>
                 <button onClick={() => setActiveFilter('over')} className={`flex items-center gap-2 px-6 py-3.5 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all ${activeFilter === 'over' ? 'bg-slate-800 text-white shadow-md' : 'text-slate-500 hover:text-white hover:bg-slate-800/50'}`}>
                         ...
                         <div className="flex items-center gap-4 w-[40%] shrink-0">
                            ...
                            <div className="overflow-hidden">
                               ...
                               <div className="flex gap-2 items-center mt-0.5">
                                  <span className="text-[10px] text-slate-500 font-mono tracking-widest">{test.id}</span>
                               </div>
                            </div>
                         </div>
