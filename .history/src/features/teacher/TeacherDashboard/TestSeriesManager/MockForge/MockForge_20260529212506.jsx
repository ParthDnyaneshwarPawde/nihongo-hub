...
// 🚨 UPDATED: Added Branching Fields to the Part
...
export default function MockForge() {
  ...
  // ==========================================
  // GLOBAL SAVE & BATCH WRITE ENGINE
  // ==========================================
  const handleSaveQuiz = async () => {
    ...
    try {
      ...
      parts.forEach((part) => {
        ...
        // 🚨 UPDATED: Save Part-Level Branching
                  ...
                  <div className="flex-1 flex flex-col gap-5 w-full">
                     ...
                     <div className="flex flex-wrap items-center gap-3">
                        ...
                        {part.conditionalNavigation && (
                           <div className="flex items-center gap-3 bg-amber-500/5 p-1.5 rounded-xl border border-amber-500/20 w-fit animate-in fade-in">
                              <span className="text-[9px] font-black uppercase tracking-[0.1em] text-amber-500 px-2">If Fail, Skip To:</span>
                              <select value={part.branchTargetId || ''} onChange={(e) => updatePartField(part.id, 'branchTargetId', e.target.value)} className="bg-transparent text-xs font-black text-amber-400 outline-none cursor-pointer pr-2">
