...
const generateBlankSection = () => ({
  ...
  branchTargetId: '', // Added for Branching selection
  isExpanded: true,
...
const generateBlankPart = () => ({
  ...
  timeLimitMinutes: 45,
  breakAfterMinutes: 0, // Added for Breaks
  isExpanded: true,
...
export default function MockForge() {
  ...
  // Nested Mutators (Parts/Sections/Questions)
  ...
  // 🚨 CORRECTED: Calculate Sum of Correct Options for Multiple Choice, Max for Single Choice
  ...
  const handleSaveQuiz = async () => {
    ...
    // 🚨 DURATION VALIDATION (Working vs Breaks)
    ...
    try {
      ...
      parts.forEach((part) => {
        ...
        part.sections.forEach((section) => {
          ...
          activeQs.forEach((q) => {
            ...
            batch.set(doc(db, `question_bank/global_mocks/questions`, finalQId), {
              ...
              afterTimeHint: q.afterTimeHint, timeWarningMessage: q.timeWarningMessage, audioPlaybackType: q.audioPlaybackType,
          ...
          sectionPayloads.push({
            ...
            conditionalNavigation: section.conditionalNavigation, branchTargetId: section.branchTargetId,
        ...
        structuredPartsPayload.push({
          ...
          breakAfterMinutes: Number(part.breakAfterMinutes), sections: sectionPayloads
        });
      });
      ...
      batch.set(examRef, { 
        ...examSettings, id: examRef.id, type: 'blueprint', authorId: actualTeacherId,
        collaborators: exerciseId ? undefined : [actualTeacherId], 
        createdAt: serverTimestamp(), totalPoints: totalPointsSum, totalBreakMinutes: sumOfBreaks,
        parts: structuredPartsPayload, isCompleted: false 
      }, { merge: true });
                              ...
                              <div className="flex-1 space-y-5">
                                 ...
                                 <div className="flex flex-col md:flex-row md:items-center gap-6 pt-2">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                       ...
                                       {/* Dynamic Branch Target Dropdown */}
